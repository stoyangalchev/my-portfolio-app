    ...
    <div className="absolute flex items-center flex-col  bottom-0 right-0 mr-8  h-[50vh] max-lg:hidden ">
      <div className=" h-[65%] w-[4rem] flex items-center justify-center ">
        <Link
          ...
          className="text-blue-700 mb-2 [writing-mode:vertical-lr] absolute top-0 right-0 h-[50%] text-[--blue] hover:text-[--lightblue] transition-all duration-200 -translate-y-20"
        >
